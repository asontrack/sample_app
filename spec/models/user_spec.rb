...
describe User do
  ...
  it 'should reject duplicate email address' do
    # Put the user with given email adress to database
    User.create!(@attr)
  ...
  describe 'password encryption' do
    ...
    describe 'has_password? method' do
      ...
      it 'should not be true if the password dont match' do
    ...
    describe 'authenticate method' do
      ...
      it 'should return nil for email adress with no user' do
        nonexist_user = User.authenticate('bar@foo.comn', @attr[:password])
